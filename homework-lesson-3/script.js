...
//якщо будь-який з операндів є рядком, тоді бінарний + перетворює інший операнд також на рядок
...
//унарний + 14 номер, бінарний + 11 номер, тому першим буде виконуватись унарний +
...
//потім маємо оператор строгої рівності ===, порівнюємо число 5 та число 6 на рівність
//отримуємо false
...
//маємо оператор строгої рівності ===, порівнюємо число 5 та число 6 на рівність
//отримуємо false
//якщо будь-який з операндів є рядком, тоді бінарний + перетворює інший операнд також на рядок
